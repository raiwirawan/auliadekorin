			...
			<div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
				...
				>
					...
					<p className="text-neutral-600 mb-8">
						Congratulations! Your personalized wedding invitation is ready to be
		...
		<div className="h-screen bg-white flex flex-col md:flex-row overflow-hidden">
			...
			>
				...
				<div className="w-full py-10 flex flex-col items-center">
					{/* Phone label */}
					<p className="text-xs font-semibold text-neutral-400 uppercase tracking-widest mb-4 select-none">
						Live Preview
					</p>

					{/* Phone frame — fixed 390px (iPhone size), naturally tall */}
					<div className="w-[390px] max-w-full rounded-[48px] overflow-hidden shadow-2xl border-10 border-neutral-800 bg-neutral-800">
						{/* Notch bar */}
						<div className="flex justify-center items-center h-7 bg-neutral-800">
							<div className="w-24 h-4 bg-neutral-900 rounded-full" />
						</div>
						{/* Screen */}
						<div className="overflow-hidden rounded-b-[38px]">
							<WeddingPageView wedding={formData} isPreview />
						</div>
					</div>

					<p className="text-xs text-neutral-400 mt-6 select-none">
