...
if (
	...
	!document.getElementById("testimonial-fonts")
) {
...
const testimonials: Testimonial[] = [
	{
		id: 1,
		quote:
			"AuliaDekorin berhasil mengubah halaman rumah kami yang sederhana menjadi sesuatu yang luar biasa. Setiap tamu berhenti untuk berfoto di depan gapura — kami masih menerima pesan tentang hal itu.",
		highlight: "luar biasa.",
		name: "Ayu Rahayu",
		role: "Pengantin Wanita",
		partner: "AuliaDekorin",
		weddingDate: "Maret 2026",
	...
	},
	{
		id: 2,
		quote:
			"Awalnya saya khawatir dengan riasan pengantin — saya jarang memakai riasan sehari-hari. Kak Aulia mendengarkan semua keinginan saya, melakukan uji coba, dan pada hari pernikahan saya tampil seperti diri saya yang terbaik.",
		highlight: "diri saya yang terbaik.",
		name: "Sari Dewi",
		role: "Pengantin Wanita",
		partner: "AuliaDekorin",
	...
	},
	{
		id: 3,
		quote:
			"AuliaDekorin menangkap momen yang bahkan kami sendiri tidak sadari terjadi — Ayah saya menyeka matanya, suami saya tertawa bersama sahabatnya. Karya yang tak ternilai dan tak tergantikan.",
		highlight: "tak ternilai dan tak tergantikan.",
		name: "Diah & Bimo",
		role: "Pasangan Pengantin",
		partner: "AuliaDekorin",
		weddingDate: "Februari 2026",
	...
	},
	{
		id: 4,
		quote:
			"Penataan meja pesta kami benar-benar di luar dugaan. AuliaDekorin langsung memahami gaya minimalis, natural, dan khas Bali yang kami impikan — dan berhasil mewujudkannya dengan sempurna.",
		highlight: "mewujudkannya dengan sempurna.",
		name: "Ratih Kusuma",
		role: "Pengantin Wanita",
		partner: "AuliaDekorin",
	...
	},
	{
		id: 5,
		quote:
			"Tiga sahabat pengiring pengantin saya langsung memesan jasa Kak Aulia setelah melihat hasil riasan saya. Sejauh ini, itulah ulasan terbaik yang bisa diberikan.",
		highlight: "terbaik.",
		name: "Nadia Permata",
		role: "Pengantin Wanita",
		partner: "AuliaDekorin",
...
function TestimonialCard({
	...
	return (
		<div
			className="relative w-full h-full rounded-4xl overflow-hidden select-none"
			style={{
		...
		<section className="py-28 px-6 bg-white overflow-hidden">
			<div className="max-w-7xl mx-auto">
				...
				>
					...
					>
						Testimoni nyata dari pasangan nyata yang mempercayakan acara mereka
						kepada kami.
					</p>
				</motion.div>
					...
					{slots.map((slot) => {
						...
						return (
							<motion.div
								...
								dragElastic={0.08}
								onDrag={(_, info) => {
									/* drag offset tracked internally by motion */
								}}
								onDragEnd={(_, info) => {
				...
				<div className="flex flex-col items-center gap-8 mt-16">
					...
					>
						...
						>
							Berdasarkan beberapa ulasan terverifikasi dari pasangan Indonesia
						</span>
					</motion.div> */}
				</div>
			</div>
