...
const attires = [
  {
    ...
    description: 'Setelan jas modern dengan potongan pas badan untuk tampilan yang elegan.',
  },
  {
    id: 2,
    image: '/attire/attire2.webp',
    title: 'Classic Tuxedo',
    description: 'Tuksedo klasik hitam yang sempurna untuk acara pernikahan formal.',
  },
  {
    id: 3,
    ...
    <section className="py-24 bg-white" id="portfolio">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Koleksi jas dan busana pengantin premium untuk menyempurnakan penampilan Anda di hari bahagia.
          </motion.p>
        </div>
