		...
		>
			...
			<div className="max-w-7xl mx-auto px-6 relative z-10">
				<div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
					...
					>
						Kami menggabungkan seni floral, tata cahaya dramatis, dan detail
						estetik untuk menciptakan latar belakang sempurna bagi momen bahagia
						Anda.
					</motion.p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-6">
					...
					<motion.div
						...
						className="md:col-span-8 group relative rounded-3xl overflow-hidden aspect-4/3 md:aspect-video bg-neutral-900 border border-white/5"
					>
						<img
							src="/decor/wedd.webp"
							alt="Dekorasi Utama"
						...
						<div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-8 md:p-12">
							...
							<p className="text-neutral-300 max-w-xl mb-6">
								Kemegahan tanpa batas dengan lorong bunga yang membentang indah,
					...
					<div className="md:col-span-4 flex flex-col gap-6">
						...
						>
							...
							<div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8">
								...
								<p className="text-sm text-neutral-300 mb-4">
									Nuansa hangat dengan elemen natural yang romantis.
								</p>
							</div>
						</motion.div>
						...
						>
							...
							<div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8">
								...
								<p className="text-sm text-neutral-300 mb-4">
									Detail klasik untuk momen sakral yang tak terlupakan.
								</p>
							</div>
						</motion.div>
					</div>
