...
const slides: Slide[] = [
  {
    ...
    caption: 'Lush floral archways hand-crafted for an open-air garden ceremony.',
  },
  {
    id: 2,
    ...
    caption: 'Timeless soft-glam bridal look that photographs beautifully in any light.',
  },
  {
    id: 3,
    ...
    caption: 'Elevated table settings — candles, pampas grass, and bespoke centrepieces.',
  },
  {
    id: 4,
    ...
    caption: 'Golden-hour portraits that tell the story of your most important day.',
  },
  {
    id: 5,
    ...
    caption: 'Seasonal bouquets and aisle florals sourced from local Balinese growers.',
  },
  {
    id: 6,
    ...
    caption: 'Full hair and makeup sessions — from first trial to the big morning.',
  },
];
...
function ProgressBar({ duration, isPlaying, slideKey }: { duration: number; isPlaying: boolean; slideKey: number }) {
  return (
    <div className="h-0.5 w-full bg-white/20 rounded-full overflow-hidden">
      <motion.div
        ...
        transition={isPlaying ? { duration: duration / 1000, ease: 'linear' } : { duration: 0 }}
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 lg:hidden">
        <DotNav count={slides.length} active={current} onSelect={(i) => goTo(i, i > current ? 1 : -1)} />
      </div>
